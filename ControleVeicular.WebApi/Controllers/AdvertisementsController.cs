...
namespace ControleVeicular.WebApi.Controllers
{
    ...
    public class AdvertisementsController : ControllerBase
    {
        ...
        public AdvertisementsController(DataContext context, IControleVeicularRepository repository)
        {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                var results = await Repository.GetAll<Advertisement>();
                return Ok(results);
            }
            catch (Exception)
            {
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            try
            {
                var results = await Repository.GetById<Advertisement>(id);
                return Ok(results);
            }
            catch (Exception)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Post(Advertisement model)
        {
            try
            {
        ...
        [HttpPut("{Id}")]
        public async Task<IActionResult> Put(Guid Id, Advertisement model)
        {
            try
            {
                var advertisement = await Repository.GetById<Advertisement>(Id);
